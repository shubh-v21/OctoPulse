...
// Add this for scrollable card content
...
>(({ className, maxHeight = "300px", ...props }, ref) => (
  <div
    ref={ref}
    className={cn("p-6 pt-0 custom-scrollbar", className)}
...
export { Card, CardHeader, CardFooter, CardTitle, CardDescription, CardContent, ScrollableCardContent }
